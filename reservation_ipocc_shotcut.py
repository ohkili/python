...
info_ipo_ex1,info_date_ex1, key_pair = info_ipo_ex(info_path, id_no = 1) # login info, reserve date, running key for macro from ipo_reserve_order.xlsx

telegram_message('info_path was done')
if pass_cal() == key_pair['Pass_key']:
    ...
    telegram_message('reserve_ipo3 was done')
else:
    pass
